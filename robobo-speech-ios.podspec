...
Pod::Spec.new do |s|
    ...
    s.homepage         = 'https://github.com/mintforpeople/robobo-speech-ios'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'LGPLv3', :file => 'LICENSE' }
    s.author           = { 'Luis Felipe Llamas Luaces' => 'luis.llamas@mintforpeople.com' }
    s.source           = { :git => 'https://github.com/mintforpeople/robobo-speech-ios.git', :tag => s.version.to_s }
    ...
    s.dependency 'robobo-remote-control-ios', '~>0.1.0'
